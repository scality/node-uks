...
var utils = {
  ...
  genIdFromInt: function(base, MDclass) {
    ...
    var md5 = crypto.createHash('md5').update(basehexa);l
  ...
  uks_gen: function(oid, volid, svcid, spid, cls) {
    // TODO
  },

  uks_gen_raw: function(hash, oid, volid, svcid, spid, cls) {
    // TODO
  },

  uks_parse: function(key) {
    // TODO
  },

  serialize_md: function(mds) {
    // TODO
  },
